...
class UserRejectHiveRepositoryAdapter implements UserRejectRepository {
  ...
  Future<UserReject?> findByCategory(UserRejectCategory category) async {
    ...
    if(userRejectHiveEntity == null) {
      ...
      return UserReject(
        category: UserRejectCategory.findByName(userRejectHiveEntity.categoryName),
        rejectedAt: userRejectHiveEntity.rejectedAt,
        expiredAt: userRejectHiveEntity.expiredAt
      );
    }

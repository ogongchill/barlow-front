...
import 'package:design_system/theme/test_style_preset.dart' show TextStylePreset;
import 'package:features/bill_info/presentation/viewmodel/recent_bill_post_viewmodel.dart';
import 'package:features/bill_info/presentation/viewmodel/recent_bill_tag_viewmodel.dart';
import 'package:features/shared/domain/bill_post_tag.dart';
import 'package:flutter/material.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

class RecentBillPostTagModalView extends ConsumerWidget {
  ...
  const RecentBillPostTagModalView({super.key});
  ...
  Widget _buildProposerTypeTag(WidgetRef ref) {
    ...
    final billPostTagState = ref.read(recentBillTagProvider);
    final billPostTagNotifier = ref.read(recentBillTagProvider.notifier);
    return Container(
  ...
  Widget _buildProgressStatusTag(WidgetRef ref) {
    ...
    final billPostTagState = ref.watch(recentBillTagProvider);
    final billPostTagNotifier = ref.read(recentBillTagProvider.notifier);

...
import 'package:features/bill/domain/usecases/committtee_subscription_usecase.dart';
import 'package:flutter_riverpod/flutter_riverpod.dart';

final fetchCommitteeSubscriptionUseCaseProvider = Provider<FetchCommitteeSubscriptionUseCase>((ref) {
  return dependencyContainer<FetchCommitteeSubscriptionUseCase>();
});
...
FutureProvider.family<void, CommitteeSubscription>((ref, committeeSubscription) async {
  final useCase = dependencyContainer<ToggleCommitteeSubscriptionUseCase>();

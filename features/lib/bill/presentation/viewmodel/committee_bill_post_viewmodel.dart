...
import 'package:features/bill/domain/usecases/committee_bill_post_usecases.dart';
...
class CommitteeBillPostViewModel extends StateNotifier<CommitteeBillPostState> {
  ...
  Future<void> _fetchBills() async {
    final useCase = dependencyContainer<FetchCommitteeBillPostThumbnailsUseCase>();

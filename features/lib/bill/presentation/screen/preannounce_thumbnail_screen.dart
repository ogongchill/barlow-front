...
import 'package:features/bill/presentation/view/bill_thumbnail_tag_modal_view.dart';
import 'package:features/bill/presentation/widgets/legislative_process_widget.dart';
...
class PreAnnounceThumbnailScreen extends ConsumerWidget {
  ...
  const PreAnnounceThumbnailScreen({super.key});
    ...
    return Scaffold(
        ...
        body: NestedScrollView(
            ...
            body: NotificationListener<ScrollNotification>(
              ...
              child: const PreAnnounceThumbnailView(),
            )
        )
    );
  }

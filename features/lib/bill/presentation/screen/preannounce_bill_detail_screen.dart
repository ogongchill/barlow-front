...
import 'package:features/bill/presentation/viewmodel/preannounce_bill_detail_viewmodel.dart';
...
class PreAnnounceBillDetailScreen extends ConsumerWidget {
  ...
  const PreAnnounceBillDetailScreen({super.key, required this.billId});

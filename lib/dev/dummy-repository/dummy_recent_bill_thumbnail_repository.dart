...
class DummyRecentBillThumbnailRepository implements RecentBillRepository {
  ...
  Future<List<BillThumbnail>> retrieve(Page? page, List<BillPostTag>? tags) async {
    ...
    print("GET : fetch recentBillThumbnails with ${tags!.map((tag) => tag.value).toList()},,, pageIndex : ${currentPage.index}  sizd : ${currentPage.size},,,");

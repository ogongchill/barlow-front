...
class PreAnnounceBillPostsResponseBody {
  ...
  final List<PreAnnounceBillThumbnail> thumbnails;
...
@JsonSerializable()
class PreAnnounceBillThumbnail{
  ...
  factory PreAnnounceBillThumbnail.fromJson(Map<String, dynamic> json) => _$PreAnnounceBillThumbnailFromJson(json);
}

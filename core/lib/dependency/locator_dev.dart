...
import 'package:core/database/notification/notification_read_status_repository_adapter.dart';
import 'package:core/database/secure-storage/token_repository.dart';
import 'package:core/database/setting/user_reject_hive_repository_adapter.dart';
...
import 'package:core/database/user/user_info_hive_repository.dart';
...
import 'package:features/bill_info/infra/recent_bill_repository_adapter.dart';
...
import 'package:features/committee/domain/usecases/committee_bill_post_usecases.dart';
...
import 'package:features/committee/infra/commitee_profile_repository_adpater.dart';
import 'package:features/committee/infra/committee_bill_post_respository_adapter.dart';
import 'package:features/committee/infra/committee_notification_repository_adapter.dart';
import 'package:features/committee/infra/committee_subscription_repository_adapter.dart';
import 'package:features/home/domain/usecases/get_home_usecase.dart';
import 'package:features/home/infra/home_repository_adapters.dart';
...
import 'package:features/notification/infra/received_notification_respository_adapter.dart';
import 'package:features/pre_announce/domain/usecases/fetch_preannounce_bill_detail_usecase.dart';
import 'package:features/pre_announce/domain/usecases/fetch_preannounce_thumbnail_usecase.dart';
import 'package:features/pre_announce/infra/preannounce_bill_detail_repository_adapter.dart';
import 'package:features/pre_announce/infra/preannounce_bill_thumbnail_respository_adapter.dart';
...
import 'package:features/settings/infra/notification_repository_adapter.dart';
import 'package:features/settings/infra/user_account_withdraw_repository_adpater.dart';
...
import 'package:features/splash/domain/serivce/app_version_status_remote_config_repository_adapter.dart';
...
import 'package:features/splash/domain/usecases/login_usecase.dart';
...
import 'package:features/splash/infra/app_anitialize_info_repository_adapter.dart';
import 'package:features/splash/infra/auth_repository_adapter.dart';
...
Future<void> setUpDevLocator() async {
  ...
  /// for barlow-api
  getIt.registerLazySingleton<HeaderInterceptor>(
    () => HeaderInterceptor(
  ...
  getIt.registerLazySingleton<ApiRouter>(
          ...
          apiClient: ApiClient(
              ...
              interceptors: [getIt<HeaderInterceptor>(), LoggerInterceptor()]
          )
      )
  );
